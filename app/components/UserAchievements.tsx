...
> = {
  ...
  BULK_TIP_CREATED: { icon: <Bars4Icon /> },
  BULK_TIP_FUNDED: { icon: <WalletIcon /> },
  BULK_TIP_10: { icon: <Bars4Icon /> },
  BULK_TIP_25: { icon: <Bars4Icon /> },
  BULK_TIP_50: { icon: <Bars4Icon /> },
  BULK_TIP_100: { icon: <Bars4Icon /> },
  BULK_TIP_CLAIMED: { icon: <GiftIcon /> },
  BULK_TIP_WITHDRAWN: { icon: <ArrowsRightLeftIcon /> },
  BULK_TIP_ALL_WITHDRAWN: { icon: <ChartBarSquareIcon /> },
  TIPPED_A_BITCOINER: { icon: <ForwardIcon /> },
  PRINTED_CARD_TIP_CLAIMED: { icon: <PrinterIcon /> },
  PRINTED_CARD_TIP_WITHDRAWN: { icon: <PrinterIcon /> },
};
